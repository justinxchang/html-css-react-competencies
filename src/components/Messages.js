    ...
    render(){
        let displayedMessages = this.state.messages.map((message, i) => (
            <div className="message" key={i}>
                {message}
                <div className='shift'>
                    <button className='button' onClick={() => this.editMessage(i)}><img className='icon' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgH9892b5wrduqjSffVJ0n9__kwyS-8mveTsZzTOn72XEMDb1d'/>
                    </button>
